...
ARG1: Port
ARG2: Can be whatever you want. It will activate that „special settings“ get sent to the client
regulary
...
Note that it will create 20 rebel clients starting from port 6000. The port number increases with
every client.
